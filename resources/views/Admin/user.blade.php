            ...
            <div class="card-body">
                ...
                <form class="forms-sample">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="a_name" placeholder="Username">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">邮箱</label>
                        <input type="email" class="form-control" id="a_email" placeholder="Email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleInputConfirmPassword1">密码</label>
                        <input type="password" class="form-control" id="a_pwd" placeholder="Password">
                    </div>

                    <button type="submit" class="btn btn-gradient-primary mr-2" id="btn">提交</button>
